...
def train(cfg):
    ...
    for epoch_idx in range(start_epoch, epochs):
        ...
        eval_one_epoch(save_dir_exp, InferImgLoader_RoI, model, dim_prior, gt_dir, epoch_idx+1, ap_mode=40)



def eval_one_epoch(save_dir_exp, InferImgLoader_RoI, model, dim_prior, gt_dir, epoch_idx, ap_mode=40):
