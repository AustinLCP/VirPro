...
from lib.encoder_pretrain.ppl.ppl_text_encoder_multi_pan import PPLTextEncoderMultiPAN
...
def train(cfg):
    ...
    text_encoder = PPLTextEncoderMultiPAN(class_names, 3).to('cuda')
    ...
    for epoch_idx in range(start_epoch, epochs):
        ...
        for batch_idx, sample in enumerate(TrainImgLoader_RoI):
            ...
            # text modality
            text_embed, loss_prompt = text_encoder(img_feat) # text_embed: [8, 3, 512]
