...
from tools.data_converter.utils_gga import project_pts_on_img, points_in_frustm_indices # calculate_ground_fgr, region_grow_fgr
...
def get_2d_boxes(info, occluded, mono3d=True):
    ...
    for ann_idx, ann_rec in enumerate(ann_recs):
        ...
        if mono3d and (repro_rec is not None):
            # kitti label: [x_min,y_min,x_max,y_max, h,w,l, x,y,z, r]
            # GGA label:   [x_min,y_min,   w,   h,   x,y,z, l,h,w, r]
            # dim_hwl = np.take(dim, [1, 2, 0], axis=-1)
